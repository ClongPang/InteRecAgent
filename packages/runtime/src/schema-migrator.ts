...
const REQUIRED_TABLES: Readonly<Record<string, readonly string[]>> = {
  ...
  turns: ["conversation_id", "client_turn_id", "request_hash", "base_revision", "status", "attempt", "fence_token", "lease_expires_at"],
  turn_attempts: ["turn_id", "attempt", "fence_token", "status", "plan_json", "draft_json", "evidence_keys"],
  ...
  offer_qualifications: ["conversation_id", "turn_id", "attempt", "source_listing_id", "offer_ref", "comparison_key", "status", "reason_codes"],
