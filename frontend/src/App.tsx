...
function PlatformMark({ tone, name }: { tone: string; name: string }) { return <span className={`platform-mark platform-mark--${tone}`}><img src={platformLogo[tone]} alt={name} /></span> }
