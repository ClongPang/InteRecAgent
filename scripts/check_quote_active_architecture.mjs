...
const allowedScripts = new Set([
  ...
  "check_identity_grounded_quote_contract.mjs",
  "check_identity_grounded_quote_drift.mjs",
  ...
  "identity-grounded-identity-fixture.ts",
  "identity-grounded-trajectory-fixtures.ts",
  "quote_live_acceptance_controlled.ts",
  "quote_live_acceptance_history.ts",
  "quote_live_acceptance_identity.ts",
  "quote_live_acceptance_support.ts",
  "run_postgres_integration.mjs",
  "run_identity_grounded_trajectories.ts",
  "run_identity_resolution_shadow_replay.ts",
  "run_identity_mutations.ts",
