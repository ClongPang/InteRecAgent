...
const boundaries = [
  ...
  { file: "packages/domain/src/quote-effects.ts", maxLines: 130, requires: ["QuoteEffect", "applyQuoteEffectResult", "pre-effect state"] },
  ...
  { file: "scripts/run_identity_grounded_trajectories.ts", maxLines: 360, requires: ["validateSpec", "runSuccessfulTrajectories", "runRejectedPlans"] },
